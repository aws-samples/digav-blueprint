...
export class RegionRestriction extends cdk.Construct {
	...
	constructor(scope: cdk.Construct, id: string, props: RegionRestrictionProps) {
        ...
        const permissionBoundaryPolicyContent = JSON.parse(fs.readFileSync("scripts/policy-regionrestrictions-permissionboundary.json", {
            encoding: "utf-8",
        })); 
        ...
        const customManagedPolicy = new iam.ManagedPolicy(this, "Permissions-Boundary-Policy", {
            document: customPolicyDocument
        });

        const sampleRole = new iam.Role(this, "Sample-Role", {
